<?php
include("../controller/blocklist_cont.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="profile_container">
        ...
        <nav>
            <ul>
				...
				<li><a href="blocklist.php" rel="noopener noreferrer" class="active">BlockList<span class="badge"><?php echo $get_blocked_frnd_num;?></span></a></li>
        ...
        <div class="all_users">
            ...
            <div class="usersWrapper">
                <?php
                if($get_blocked_frnd_num > 0){
                    foreach($get_all_blocked_friends as $row){
                    ...
                    echo '<h4>You have no BLocked friends!</h4>';
                }
                ?>
            </div>
        </div>
